...
// NewGetMeetingParams creates a new GetMeetingParams object
// no default values defined in spec.
func NewGetMeetingParams() GetMeetingParams {

	return GetMeetingParams{}
}

// GetMeetingParams contains all the bound params for the get meeting operation
...
func (o *GetMeetingParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
