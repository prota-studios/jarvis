...
func (o *ListUpcomingMeetingsURL) Build() (*url.URL, error) {
	...
	var _path = "/zoom/meetings/upcoming"
...
func (o *ListUpcomingMeetingsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListUpcomingMeetingsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListUpcomingMeetingsURL")
	}
